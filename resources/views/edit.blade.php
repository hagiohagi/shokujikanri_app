...
<div class="container">
  ...
  <div>
    ...
    <!-- <div id="meal-edit" v-bind:meal-details='@json($meal_details)'>
    </div>
    ...
    <div id="demo-area" class="form-group">
      <div class="unit row">
        <input class="form-control @error('food') is-invalid @enderror" style="width: 150px" name="food[]" value="{{$meal_detail['food']}}">
        @error('food')
        <span class="invalid-feedback" role="alert">
          <strong>{{ $message }}</strong>
        </span>
        ...
        <input class="form-control @error('ingredient') is-invalid @enderror" style="width: 150px" name="ingredient[]" value="{{$meal_detail['ingredient']}}">
        @error('ingredient')
        <span class="invalid-feedback" role="alert">
          <strong>{{ $message }}</strong>
        </span>
        ...
        <input class="form-control @error('amount') is-invalid @enderror" style="width: 150px" name="amount[]" value="{{$meal_detail['amount']}}">
        @error('amount')
        <span class="invalid-feedback" role="alert">
          <strong>{{ $message }}</strong>
        </span>
        @enderror
        <div class="demo-minus" style="width: 30px">
          <span class="batsu">
            ×
          </span>
        </div>
    ...
    @endforeach
    <div id="demo-plus" class="btn btn-secondary" style="width: 450px">
      入力欄を追加
    </div>
  </div>
